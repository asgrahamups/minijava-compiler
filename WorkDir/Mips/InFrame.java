...
public class InFrame extends arch.Access {
	...
	/**
	 * Construct a simple IRT tree consisting of the offset used to get to this
	 * item on the stack.
	 */
	public Exp getTree() {
	...
	/**
	 * This version of getTree is passed a register holding a base address, and
	 * builds a MEM construct that refers to this item on the stack (or heap).
	 * It adds the appropriate offset to the base address, and wraps the
	 * corresponding memory address in a MEM node.
	 */
