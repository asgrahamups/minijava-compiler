...
public class InReg extends arch.Access {
	...
	/**
	 * The constructor takes the Arch.Reg register that corresponds to the
	 * position of this data item.
	 * 
	 * @param t
	 *            The actual Arch.Reg that's holding this item
	 */
	public InReg(Reg t) {
		temp = t;
	}
	 ...
	 * <code>getTree()</code> since we're not at an offset from any base address
	 * &mdash; we're in a register.
	 */
