...
/**
 * This class defines some constants that correspond to specific registers on
 * the MIPS (e.g. <code>$sp</code>), as well as defining groups of registers:
 * Those used for passing arguments, and the callee-saved and caller-saved
 * registers. For reference, A MIPS frame allocates space for
 * <ol>
