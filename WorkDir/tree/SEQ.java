...
/**
 * A SEQ statement composes two IRT statements, with the expectation that we
 * should execute the left statement, then the right.
 */
public class SEQ extends Stm 
{
	...
	public void apply(MipsVisitor visit)
	{
