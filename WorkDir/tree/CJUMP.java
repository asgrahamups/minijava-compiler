...
public class CJUMP extends Stm {
	...
	/**
	 * The constructor takes a constant describing the comparison used in this
	 * conditional jump, expressions for the values being compared, and two
	 * destination labels.
	 * 
	 * @param rel
	 ...
	 * @param t
	 *            The label to which we should jump if the test is true
	 * @param f
	 *            The label to which we jump if the test is false
	 */
	...
	/**
	 * A routine for inverting the relational operator. For example, the
	 * opposite of EQ is NE. The opposite of GE (>=) is LT (<).
	 * 
	 * @param relop
	 *            A constant representing a relational operator
