 ...
 * and an expression, and it's understood that the statement is to be executed
 * first, then the expression is evaluated to produce the value of the overall
 * expression.
 */
public class ESEQ extends Exp {
	 ...
	 *            A statement node
	 * @param e
	 *            An expression to be evaluated after the statement(s) are
	 *            executed
	 */
