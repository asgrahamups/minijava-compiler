...
/**
 * This class provides some static constants and methods for dealing with type
 * information.
 * 
...
public class Types {
	...
	/**
	 * Returns true if the two type descriptors have the same type. It converts
	 * both to their string representations and compares the two strings.
	 * 
	 * @param t1
	 *            The first type descriptor
	 * @param t2
	 *            The second type descriptor
